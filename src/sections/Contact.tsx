      ...
      <form onSubmit={handleSubmit} className="mt-10 flex flex-col gap-4">
        ...
        {!CONTACT_EMAIL || CONTACT_EMAIL.includes('TODO') ? (
          <p className="text-xs text-ink-500">
            ...
            <code className="text-ink-300">data/profile.ts</code> (tambahkan entri social dengan{' '}
            <code className="text-ink-300">icon: 'email'</code>). Kalau mau form ini benar-benar
            mengirim tanpa membuka email client, sambungkan ke layanan seperti Formspree atau
            Resend — bagian itu sengaja belum dipasang otomatis.
          </p>
        ) : null}
      </form>
